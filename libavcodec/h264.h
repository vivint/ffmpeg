...
#define MAPTYPE_EPTZ 120
#define MAPTYPE_ZCLS 112

#define PTZ_UUID_INDEX 0
#define PTZ_MAP_TYPE_INDEX 4
#define PTZ_DIVISOR_INDEX 5
#define PTZ_X_INDEX 6
#define PTZ_Y_INDEX 7
#define PTZ_Z_INDEX 8

#define PTZ_DATA_NUM_ELEMENTS 16
...
#define PART_NOT_AVAILABLE -2
    ...
    uint32_t sei_unregistered_user_data[PTZ_DATA_NUM_ELEMENTS];
