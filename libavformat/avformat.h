...
typedef struct AVInputFormat {
    ...
    /**
     * Send a set parameter command - only meaningful if using RTSP
     */
    int (*set_parameter)(struct AVFormatContext *, const char *, const char *);
...
/**
 * Send a set parameter command for an RTSP stream
 */
int av_set_parameter(AVFormatContext *s, const char *key, const char *value);
